...
const WeatherCurrentCity: React.FC<PropsType> = ({ dataWeather, degCelsius, changeValueDeg }) => {

    const currentTime: string = dataWeather ? getTime(getCurrentTime(dataWeather.city.timezone)) : '';
